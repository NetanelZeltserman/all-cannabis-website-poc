...
export default function HeroSection() {
  return (
    <div className="w-full h-full grid container lg:grid-cols-2 items-center justify-items-center gap-5">
        <div className="order-2 lg:order-1 flex flex-col justify-center items-start">
            ...
            <p className="text-4xl font-medium text-secondary md:text-7xl">איפה, איך, מתי?</p>
